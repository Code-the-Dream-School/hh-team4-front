...
const AllDrugs = () => {
    ...
    const { filterTitle, alarmFilterData: alarmFilterData } = location.state || {};
    ...
    return (
        <Wrapper>
            ...
            <div className="centered-container">
                ...
                <div className="filter-search-box">
                    ...
                    <div className="search-box">
                        ...
                        <input type="text" placeholder="Search by drug name ..." className="search-input"  />
                    </div>
                </div>
            ...
            {/*  */}
            {!alarmSection && <div className="grid-container">
